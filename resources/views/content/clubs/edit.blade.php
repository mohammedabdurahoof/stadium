...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Club /</span> Edit
    </h4>
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                    ...
                    <form action="{{ route('clubs.update', $club->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="no_matches" name="no_matches"
                                ...
                                value="{{ old('no_matches', $club->no_matches) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="total_crowds" name="total_crowds"
                                placeholder="Enter Total Crowds..."
                                value="{{ old('total_crowds', $club->total_crowds) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="average_crowds" name="average_crowds"
                                placeholder="Enter Average Crowds..."
                                value="{{ old('average_crowds', $club->average_crowds) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="season" name="season">
                                ...
                                <option value="2023-24" {{ old('season', $club->season) == '2023-24' ? 'selected' : '' }}>
                                    2023-24</option>
                                <option value="2022-23" {{ old('season', $club->season) == '2022-23' ? 'selected' : '' }}>
                                    2022-23</option>
                            </select>
