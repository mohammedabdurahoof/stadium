...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Matches /</span> Create
    </h4>
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                    ...
                    <form action="{{ route('matches.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="Enter Match Name..." value="{{ old('name') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="match_date" name="match_date"
                                placeholder="Select Event Date..." value="{{ old('match_date') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control" id="match_time" name="match_time"
                                placeholder="Select Event Time..." value="{{ old('match_time') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="team1" name="team1"
                                placeholder="Enter Team 1..." value="{{ old('team1') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="team2" name="team2"
                                placeholder="Enter Team 2..." value="{{ old('team2') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="team1_score" name="team1_score"
                                placeholder="Enter Team 1 Score..." value="{{ old('team1_score') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="team2_score" name="team2_score"
                                placeholder="Enter Team 2 Score..." value="{{ old('team2_score') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="crowd" name="crowd"
                                placeholder="Enter Crowd Number..." value="{{ old('crowd') }}" />
                            ...
                            <select class="form-control" id="stadium_id" name="stadium_id">
                                @foreach ($stadia as $stadium)
                                    <option value="{{ $stadium->id }}"
                                        {{ old('stadium_id') == $stadium->id ? 'selected' : '' }}>
