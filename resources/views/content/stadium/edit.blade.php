...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Stadium /</span> Edit
    </h4>
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Edit Stadium</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('stadium.update', $stadium->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="stadium_name" name="stadium_name"
                                ...
                                value="{{ old('stadium_name', $stadium->stadium_name) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="description" name="description" class="form-control" placeholder="Enter Description...">{{ old('description', $stadium->description) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="location" name="location"
                                placeholder="Enter Location..." value="{{ old('location', $stadium->location) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="state" name="state"
                                placeholder="Enter state..." value="{{ old('state', $stadium->state) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="country" name="country"
                                placeholder="Enter country..." value="{{ old('country', $stadium->country) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="address" name="address"
                                placeholder="Enter Address..." value="{{ old('address', $stadium->address) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="capacity" name="capacity"
                                placeholder="Enter Capacity..." value="{{ old('capacity', $stadium->capacity) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="seats" name="seats"
                                placeholder="Enter Seats..." value="{{ old('seats', $stadium->seats) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="record_crowd" name="record_crowd"
                                placeholder="Enter Record Crowd..."
                                value="{{ old('record_crowd', $stadium->record_crowd) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="opened" name="opened"
                                placeholder="Enter Year Opened..." value="{{ old('opened', $stadium->opened) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="other_names" name="other_names"
                                ...
                                value="{{ old('other_names', $stadium->other_names) }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="sports_played" name="sports_played"
                                placeholder="Enter Sports Played..."
                                value="{{ old('sports_played', $stadium->sports_played) }}" />
